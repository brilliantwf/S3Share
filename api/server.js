...
var privateKey = fs.readFileSync('/etc/ssl/certs/server1.key', 'utf8');
var certificate = fs.readFileSync('/etc/ssl/certs/server1.pem', 'utf8');
...
app.post('/form', function(req, res) {
	...
	//console.log('https://ec2-52-80-108-141.cn-north-1.compute.amazonaws.com.cn/viewcontents.html?' + query);
        res.redirect('https://apache.awsdemo.com/viewcontents.html?' + query);
    }, 1000)
	  //console.log(res)
